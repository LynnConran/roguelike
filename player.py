...
class Player(creature.Creature):
    ...
    def __init__(self, floor_plan, x_position, y_position, window):
        super().__init__(floor_plan, x_position, y_position, window, '@')

    def look(self):  # Returns a list of tuples of 'seen' tiles each turn
